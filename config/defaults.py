...
# Set True if Pre-training path points to previously trained/aborted model
...
_C.SOLVER.LR_STEPS = (2, 4, 5)
# warm up factor
_C.SOLVER.USE_WARMUP_LR = False
# epochs of warm up
...
_C.REPRODUCIBLE_NUM_RUNS = 1 #default is 3
# Seed to start with
