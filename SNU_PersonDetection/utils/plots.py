...
from SNU_PersonDetection.utils.general import (CONFIG_DIR, FONT, LOGGER, Timeout, check_font, check_requirements, clip_coords,
                           increment_path, is_ascii, try_except, xywh2xyxy, xyxy2xywh)
from SNU_PersonDetection.utils.metrics import fitness
